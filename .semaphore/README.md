...
```
cat /home/vagrant/.ssh/id_rsa_example_repo | base64  -w 0
```

- Add this string to a Semaphore secret

```
$ cat secret-with-private-ssh-key.yml
apiVersion: v1alpha
kind: Secret
metadata:
...
- push secret to semaphore
    ...
    ```
    sem create -f secret-with-private-ssh-key.yml
    ```
